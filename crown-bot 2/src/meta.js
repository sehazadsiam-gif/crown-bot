...
const {
  ...
  IG_TOKEN, IG_USER_ID,
  // Which host serves your Instagram messages depends on how you connected:
  //   Business Login for Instagram (standalone) -> https://graph.instagram.com
  //   Instagram linked to a Facebook Page       -> https://graph.facebook.com
  // If sends fail with an unsupported-endpoint error, switch this.
...
export async function sendMessage(platform, psid, text) {
  ...
  // Instagram rejects messaging_type; it is Messenger-only.
