...
/**
 * Messages from one person must be handled one at a time, or two messages in
 * the same payload race each other: both read the same history and send
 * overlapping replies. One promise chain per sender, run in order.
 */
